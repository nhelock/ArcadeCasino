...
public class DoubleOrNothing : MonoBehaviour
{
    ...
    void UpdateUI()
    {
        winningsText.text = "You have: $" + WalletManager.Instance.Wallet;
    ...
    IEnumerator FlipCoin(bool win)
    {
        ...
        if (win)
        {
            ...
            resultText.text = "You doubled your bet! Now at $" + WalletManager.Instance.Wallet + "!";
        }
        else
        {
    ...
    {
        resultText.gameObject.SetActive(true);
        resultText.text = "Cashed out with $" + WalletManager.Instance.Wallet;
    ...
    void ClearBet()
    {
        WalletManager.Instance.AddMoney(totalBet);
        totalBet = 0;
        UpdateUI();
    }
}
